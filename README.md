...
- ✅ Ridge regression com regularização (L2) e recency weighting para modelo de pontos esperados
- ✅ Features de forma recente (últimas 3 rodadas) — detecta alta/queda de forma
- ✅ Leave-one-round-out CV para validação honesta do modelo vs. heurística
- ✅ Critério de adoção: modelo só ativo se bater heurística out-of-sample
- ✅ Otimização: cache de lookups por time em `enriquecer_com_confronto` (~20 vs. ~500 chamadas)
- ✅ UI: nomes de times padronizados com siglas no dashboard